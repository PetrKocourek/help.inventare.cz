...
| Evidenční jednotka (EJ) | Základní jednotka pro počítání a vykazování množství archiválií. Viz též [pravidla zpracování archiválií](https://stands.nacr.cz/zp/02-arch-zprac.html#evidencni-jednotky). |
...
| Množstevní evidenční jednotka | Jednotka, do níž se sdružují archiválie, které se nevykazují jako jednotliviny. Patří sem kartony, fascikly, balíky, pořadače a některé digitální archivní jednotky. Viz též [pravidla zpracování archiválií](https://stands.nacr.cz/zp/02-arch-zprac.html#evidencni-jednotky-pro-evidenci-mnozstevnich-jednotek-a-jednotlivin). |
...
|<span class="term-with-icon"><img src="../img/archival-folder.svg" class="icon-3em" alt="ikona Složka">Složka</span> | Jednotka popisu pro množstevní evidenční jednotky (kartony, fascikly, digitální archivní jednotky) a soubory více jednotlivostí (např. fotografie), může obsahovat podsložky. Viz též [pravidla popisu archiválií](https://stands.nacr.cz/zp/03-popis-arch.html#slozka).|
